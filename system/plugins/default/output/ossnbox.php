        ...
        <div class="controls">
            <?php if ($params['callback'] !== false) { ?>
                <a href="javascript:void(0);" onclick="Ossn.Clk('<?php echo $params['callback']; ?>');"
                   class='btn btn-primary'><i class="fa fa-share"></i><?php echo $params['button']; ?></a>
            <?php } ?>
            <a href="javascript:void(0);" onclick="Ossn.MessageBoxClose();" class='btn btn-danger'><i class="fa fa-times"></i><?php echo ossn_print('cancel'); ?></a>
        </div>
    </div>
