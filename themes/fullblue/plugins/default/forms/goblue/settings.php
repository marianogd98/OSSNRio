 <fieldset class="titleform">
 	<div class="alert alert-warning">
    	<?php echo ossn_print('theme:fullblue:browercache');?>
    </div>	
 	<div>	
    	<label><?php echo ossn_print('theme:fullblue:logo:site');?> (450x90 - 500 KB PNG) </label>
        <input type="file" name="logo_site" />
        <div class="logo-container-fullblue">
  	...
  	<div>	
    	<label><?php echo ossn_print('theme:fullblue:logo:admin');?> (180x45 - 500 KB JPG)</label>
